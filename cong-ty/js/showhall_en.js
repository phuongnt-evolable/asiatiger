$(function() {
    $("#inquryform").validate({rules: {subject: {required: true, rangelength: [1, 200]}, message: {required: true}}, messages: {subject: {required: "Please enter a Subject", rangelength: "Please do not more than 200 bytes.", nohtml: "Please do not enter code.", normalWord: "Please enter Subject in English only."}, message: {required: "Please enter Message.", rangelength: "Please enter Message in 20 to 3000 bytes.", nohtml: "Please do not enter code.", normalWord: "Please enter Subject in English only."}}});
