$(function() {
    $("#inquryform").validate({rules: {subject: {required: true, rangelength: [1, 200]}, message: {required: true}}, messages: {subject: {required: "Xin nhập tiêu đề !", rangelength: "Please do not more than 200 bytes.", nohtml: "Please do not enter code.", normalWord: "Please enter Subject in English only."}, message: {required: "Xin nhập nội dung gửi !", rangelength: "Please enter Message in 20 to 3000 bytes.", nohtml: "Please do not enter code.", normalWord: "Please enter Subject in English only."}}});
