            ...
            <div class="row l-main">
                <div id="flipbook-container-1" class="flipbook-container">
                    ...
                    <div id="flipbook-1" class="flipbook">
                        ...
                        <div class="fb-page">
                            <div class="page-content">
                                <div class="container">
                                    <img src="img/NienGiam/anh-mau-nho/Bia-1.jpg" class="bg-img lazy img-responsive" />
                                    <img src="img/NienGiam/anh-mau-lon/Bia-1.jpg" class="bg-img zoom-large"/>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="page-content">
                                    <div class="container">
                                        <div style="padding-top: 5%;" class="preview-content toc left">
                                            <img src="img/NienGiam/anh-mau-nho/Bia-2.jpg" class="bg-img lazy img-responsive"/>
                                            <img src="img/NienGiam/anh-mau-lon/Bia-2.jpg" class="bg-img zoom-large"/>
                                        </div>
                                        <div style="padding-top: 5%;" class="preview-content toc right">
                                            <img src="img/NienGiam/anh-mau-nho/Bia-3.jpg" class="bg-img lazy img-responsive"/>
                                            <img src="img/NienGiam/anh-mau-lon/Bia-3.jpg" class="bg-img zoom-large"/>
                                        </div>
                           ...
                           ?>
                            <div class="fb-page double">
                                <div class="page-content">
                                    <div class="container">
                                        <div style="padding-top: 5%;" class="preview-content toc left">
                                            <img src="img/NienGiam/anh-mau-nho/<?php echo $i; ?>.jpg" class="bg-img lazy img-responsive"/>
                                            <img src="img/NienGiam/anh-mau-lon/<?php echo $i; ?>.jpg" class="bg-img zoom-large"/>
                                        </div>
                                        <div style="padding-top: 5%;" class="preview-content toc right">
                                            <img src="img/NienGiam/anh-mau-nho/<?php echo $i+1; ?>.jpg" class="bg-img lazy img-responsive"/>
                                            <img src="img/NienGiam/anh-mau-lon/<?php echo $i+1; ?>.jpg" class="bg-img zoom-large"/>
                                        </div>
                        <?php    
                             if($i=$i+2) echo'    
                                            </div>
                         ...
                         ?> 
                          ...
                          <div class="fb-page double">
                                <div class="page-content">
                                    <div class="container">
                                        <div style="padding-top: 5%;" class="preview-content toc left">
                                            <img src="img/NienGiam/anh-mau-nho/Bia-5.jpg" class="bg-img"/>
                                            <img src="img/NienGiam/anh-mau-lon/Bia-5.jpg" class="bg-img zoom-large"/>
                                        </div>
                                        <div style="padding-top: 5%;" class="preview-content toc right">
                                            <img src="img/NienGiam/anh-mau-nho/Bia-7.jpg" class="bg-img"/>
                                            <img src="img/NienGiam/anh-mau-lon/Bia-7.jpg" class="bg-img zoom-large"/>
                                        </div>
                        ...
                        <div class="fb-page">
                            <div class="page-content">
                                <div class="container">
                                    <img src="img/NienGiam/anh-mau-nho/Bia-8.jpg" class="bg-img"/>
                                    <img src="img/NienGiam/anh-mau-lon/Bia-8.jpg" class="bg-img zoom-large"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="width:500px;  margin: auto;">
                        <div style="line-height: 6; float: left;"><a href="sach-nien-giam.php#1">{biadau}</a></div>
                        ...
                        <div style="line-height: 6; float: left;"><a href="sach-nien-giam.php#70">{biacuoi}</a></div>
                    </div> 
                    <div style="width:450px;  margin: auto; clear: both;">
                        <span><p style="color:red; font-weight: bold; float: left;margin-right: 10px;">*</p> {meoniengiam}</span>
                    </div>
                        <!-- end FLip Book Nav 
                    <div style="width: 200px;position: absolute;left: 890px;top: 535px;">                        
                        <div style="float: left;"> <a href="sach-nien-giam.php#70">{biacuoi}</a></div>
                    </div>-->
