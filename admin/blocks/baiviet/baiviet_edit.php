...
if (isset($_POST['btnSave'])) {    
    ...
    header("location:?com=baiviet_list&idLoaiTin=".$row['id_loai']);
}
?>
            ...
            <select name='idloai' id="idloai">
                ...
                <?php
                    ...
                    while($row_cha = mysql_fetch_assoc($rs_cha)){
                        //echo $row['article_id'];
                ?>
                <option <?php echo ($row['id_loai']==$row_cha['id']) ? "selected" : ""; ?> value='<?php echo $row_cha['id']?>'><?php echo $row_cha['TenLoaiTin'];?></option>
