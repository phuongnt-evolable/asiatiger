    ...
    $('#newsticker2').newsTicker({
		...
		$("#btnOK").click(function(){		
			...
			var us=$("#username").val();
                        ...
                        var ten_khong_dau=$("#ten_khong_dau").val();
                        var lang=$("#lang").val();
                        var idTL=$("#idTL").val();
			...
			if(us=="" ||tencty=="" || address=="" ||phone3=="" || phone2=="" || email=="" || spchinh=="" || quocgia=="0")
			{		
                                if(lang=='vi'){
