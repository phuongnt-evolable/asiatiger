...
<title><?php echo $title; ?></title>
        <meta name="keywords" content="D?t, may mặc & nguyên vật liệu, Giày, dép, da, túi, Xe hơi, xe máy, xe đạp & các linh phụ kiện, Cây, trúc, công cụ & dụng cụ gia dùng, Nguyên vật liệu & công trình xây dựng,  Điện tử, điện máy & dụng cụ thông tin điện máy, Máy móc, cơ điện & sản phẩm công nghiệp, Gia công & sản xuất Nhựa, cao su, hoá chất, Các ngành nông, lâm, ngư nghiệp & chăn nuôi, Kim loại, ngũ kim, mạ điện (xi mạ) & khuôn đúc,Giấy, đóng gói, in ấn & các sản phẩm liên quan,Vận chuyển,Ngành nghề bảo hiểm, tài chính,Quà cáp, đồ trang trí, sản phẩm công nghiệp, hàng tiêu dùng,Du lịch, nhà hàng, giải trí, thể thao & dụng cụ thể thao,Ăn uống và các thực phẩm chế biến,Ngành phục vụ và các ngành nghề khác">
	...
	<body data-spm="7224109" class="sw-layout-w1180" oncopy="return false" oncut="return false" onpaste="return false">
			...
			<div class="row l-fs">
				<?php if($com ==''){
                                    include 'blocks/test-menu-slide.php';
                                }
                                 ?>
			</div>
        ...
        ?>
         ...
         <?php
           ...
           // $str = str_replace("{tensp}" , tensp , $str);
            ...
            $str = str_replace("{nhanttqc}" , nhanttqc , $str);
            //echo $lang;
            echo $str;s
        ?>
