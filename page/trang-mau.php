<?php
    ...
    $list_trang = $modelHome->getImageByCate(1,$offset,$limit); 
        ...
        <form method="post" id="register" name="register" action="">
            ...
            <div class="block_content">
                <h3 class="reg_title">
                    ...
                    <span style="margin-left:95px">{trangmau}</span>
                </h3>
                        ...
                        <div class="content__block">
                            ...
                            <ul class="cate__post">
                                <li class="cate__post-item clearfix">
                                    <a target="_blank" href="<?php if($row['Href']==''){ echo $row['Url'];} else { echo $row['Href'];} ?>"  title="<?php echo $row['TenCT']; ?>" class="cate__post-img fancybox">
