<?php
	...
	$d = new db;
        ...
        $nha_dau_tu_vi = $_POST['nhadautu'];
        $nha_dau_tu_en = $_POST['nhadautu'];
        $nha_dau_tu_cn = $_POST['nhadautu'];
